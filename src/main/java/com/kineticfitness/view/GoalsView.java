...
/**
 * The Goals screen: set or change the fitness goals that drive the user's plan.
 *
 * <p>Backed by {@link LocalProfileStore} and {@link ProfileDAO}, the same storage the
 * profile wizard writes to, so goals set here and goals captured at signup are one record.
 */
